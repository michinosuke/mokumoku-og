...
export default function IretMedia() {
  ...
  return (
    <main className="min-h-screen relative bg-[#e9ecee]">
      ...
      <div className="flex flex-col sm:flex-row gap-8 mt-5 px-10">
        <div className="flex flex-col flex-1">
          ...
          <textarea
            ...
            className=" bg-white w-full rounded-lg px-5 py-2 mt-3 font-bold focus:outline-iret-media-theme"
          ...
          <div>
            <input
              ...
              className="bg-white px-5 py-2 rounded-lg mt-3 w-24 focus:outline-iret-media-theme"
            />
      ...
      <div className="h-16" />
      <footer className="bottom-5 text-slate-400 text-center py-4">
        ©︎ Michinosuke
      </footer>
    </main>
  );
